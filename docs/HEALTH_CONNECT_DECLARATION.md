...
The requested record types are Steps, Heart Rate, Oxygen Saturation, Respiratory Rate, Heart Rate Variability, Basal Body Temperature, Basal Metabolic Rate, Blood Glucose, Blood Pressure, Body Temperature, Height, Skin Temperature, VO2 Max, Weight, Exercise Session, Distance, Floors Climbed, Active Calories Burned, Total Calories Burned, Sleep Session, Body Fat, Lean Body Mass, Body Water Mass, and Bone Mass.
