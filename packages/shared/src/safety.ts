export const safetyNotice =
  "This is a wellness analytics summary, not medical advice. It does not diagnose conditions, prescribe treatment, recommend medication changes, or replace a qualified clinician.";
...
export function buildInsightPrompt(evidence: string[]): string {
  return [
    ...
    "Return concise, practical observations, uncertainty, and questions the user could discuss with a clinician.",
    "",
    "Evidence:",
