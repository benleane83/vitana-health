  ...
  it("adds a manually entered row to an upload preview", async () => {
    global.fetch = mockFetch({
      ...
      "/api/import/upload/preview": {
        ...
        mapping: { layout: "long", dateColumn: "observedAt", measurementColumn: "measurement", valueColumn: "value", unitColumn: "unit" },
        mappingSuggestion: { layout: "long", dateColumn: "observedAt", measurementColumn: "measurement", valueColumn: "value", unitColumn: "unit" },
        rowCount: 1,
        diagnostics: [],
        truncated: false,
        rows: [{
