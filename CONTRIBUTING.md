...
Windows tester builds are published as unsigned GitHub Releases from exact
version-matching tags. See [`docs/WINDOWS_RELEASE.md`](docs/WINDOWS_RELEASE.md)
for packaging, verification, and tester guidance.
